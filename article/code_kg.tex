...
and symbol resolution\allowbreak\ (\texttt{resolve\_symbols()} is called automatically).
...
effective---synthesising and explaining a context pack whose every line is verified
