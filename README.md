...
<p align="center">
  <img src="docs/code_kg_arch_9x16.png" alt="CodeKG architecture workflow" width="400"/>
</p>

> **Architecture Diagram Generated by PaperBanana**
>
> The architecture diagram above was generated from CodeKG's own analysis output using [PaperBanana](https://paperbanana.dev/), a tool for creating technical diagrams from structured data. The input—a complete knowledge graph of CodeKG's codebase—was generated by the CodeKG analysis engine itself (`codekg-analyze`), demonstrating how well-structured, deterministic code analysis feeds downstream visualization tools. This is a practical validation of CodeKG's core design philosophy: clean, traceable data structures enable rich, accurate, and beautiful downstream consumption.
